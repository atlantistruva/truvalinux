...
class kickerWindow(Ui_KickerWindow, QtGui.QMainWindow):
	def __init__(self):
		...
		self.connect(self.listKickers, QtCore.SIGNAL("currentIndexChanged(const QString&)"), self.setView)

		self.viewPicture.setPixmap(QtGui.QPixmap("icons/kicker_transparent.png"))
	...
	def setView(self):
		selected = str(self.listKickers.currentText())
		if selected == "Transparan":
			self.viewPicture.setPixmap(QtGui.QPixmap("icons/kicker_transparent.png"))
		elif selected == "ModernTransparan":
			self.viewPicture.setPixmap(QtGui.QPixmap("icons/kicker_toptransparent.png"))
		elif selected == "Klasik":
			self.viewPicture.setPixmap(QtGui.QPixmap("icons/kicker_classic.png"))
		else:
			self.viewPicture.setPixmap(QtGui.QPixmap("icons/kicker_modern.png"))
...
class wallpaperWindow(Ui_WallpaperWindow, QtGui.QMainWindow):
	def __init__(self):
		...
		self.connect(self.listWallpapers, QtCore.SIGNAL("itemSelectionChanged()"), self.showPicture)
