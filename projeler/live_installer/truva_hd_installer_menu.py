...
class truvaInstall(SimpleGladeApp):
	...
	def on_install_clicked(self, widget, *args):
		...
		msgtext += "boş disk alanı miktarı en az 2 GB olmalıdır.\n"
		...
		msgdialog.run()
		msgdialog.destroy()
		os.system( '%s/truva_install.py &' % self._exedir )
		self.quit()
	...
	def on_gparted_clicked(self, widget, *args):
		...
		msgtext += "en az 2 GB boş alana sahip bir bölüme ihtiyacınız\n"
